...
public class UDPClassificationTest {
	...
	public void testCalc() {
		...
		double residentialSatisfaction1 = udpClassification.calc(hhr1, sur, 2001);
		assertEquals("Residential satisfaction hh1", 0.5, residentialSatisfaction1, 0.0);
		residentialSatisfaction1 = udpClassification.calc(hhr1, sur, 2010);
		assertEquals("Residential satisfaction hh1", 0.625, residentialSatisfaction1, 0.0);
		double residentialSatisfaction2 = udpClassification.calc(hhr2, sur, 2001);
		assertEquals("Residential satisfaction hh2", 0.5, residentialSatisfaction2, 0.0);
		residentialSatisfaction2 = udpClassification.calc(hhr2, sur, 2010);
		assertEquals("Residential satisfaction hh2", 0.75, residentialSatisfaction2, 0.0);
	}
}
