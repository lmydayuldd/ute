...
public class SampleTravelTimes {
	private static final String timeUseTag = "travel";
	
	private Distribution<TimeUseDistributionRow> timeDistr;
	
	public SampleTravelTimes(Database db) throws InstantiationException, IllegalAccessException, SQLException, SecurityException, IllegalArgumentException, NoSuchFieldException {
