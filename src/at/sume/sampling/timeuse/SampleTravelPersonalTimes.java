 ...
 *
 */
public class SampleTravelPersonalTimes {
	private static final String timeUseTag = "travel personal";
	
	private Distribution<TimeUseDistributionRow> timeDistr;
	
	public SampleTravelPersonalTimes(Database db) throws InstantiationException, IllegalAccessException, SQLException, SecurityException, IllegalArgumentException, NoSuchFieldException {
