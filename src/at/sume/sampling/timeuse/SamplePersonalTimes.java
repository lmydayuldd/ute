 ...
 *
 */
public class SamplePersonalTimes {
	private static final String timeUseTag = "personal";
	
	private Distribution<TimeUseDistributionRow> timeDistr;
	
	public SamplePersonalTimes(Database db) throws InstantiationException, IllegalAccessException, SQLException, SecurityException, IllegalArgumentException, NoSuchFieldException {
